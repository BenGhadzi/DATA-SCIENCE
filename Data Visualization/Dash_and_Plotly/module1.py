...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Comparing Average Sales between Vehicle Types"))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            names = 'Vehicle_Type',
            title = 'Total Expenditure on Vehicle Type during Recession Period')
        )

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        #grouping data for plotting
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = data.groupby(['unemployment_rate','Vehicle_Type'])['Automobile_Sales'].mean().reset_index()
...
# Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
                    values= 'Advertising_Expenditure',
                    names='Vehicle_Type',
                    title='Total Yearly Advertisement Expenditure for each vehicle'))
